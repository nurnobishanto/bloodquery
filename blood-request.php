...
if(isset($_REQUEST['brid'])){
  ...
  <div class="row">
    ...
    <div class="imgcontainer mt-0 p-2 bg-danger text-light mt-5">
    ...
    <div class="col-lg-6 col-md-12 mt-lg-5 border mb-lg-5">
    ...
    <hr>
      ...
      ?>
        ...
        <div class="col-8 "><p><a href="profile.php?did=<?php 
        
          $sql2= "SELECT * FROM doners WHERE uid='$pid'";
        $run2=mysqli_query($connect, $sql2);
        while($getname=mysqli_fetch_array($run2)){
         echo $did = $getname['did'];
