...
<div class="container p-3">
   ...
   <div class="col-lg-8 col-md-10  col-center">
    ...
    <form class="shadow" action="bdoner-helper.php" method="post" class="bg-light" enctype="multipart/form-data">
      <h2 class="pt-3 text-center">Become a Doner</h2>
      <p class="text-center  p-1">Please fill the following information to Complete profile and become a dooner.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="date" value="2009-01-01" min="1960-01-01" max="2018-12-31" placeholder="When Need Blood ?" name="dob" required>     
                </div>
                <div class="col-md-6">
        ...
        <input type="hidden" name="reffer" value="self">
          ...
          <button class="btn bg-success text-light font-weight-bold" type="submit">Setup Profile</button>
