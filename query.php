...
$sql = "SELECT * FROM doners WHERE ".$bgroup.$abilty.$city.$gender;
$run = mysqli_query($connect,$sql);
$count = mysqli_num_rows($run);
echo "<div class='col-12'><p>Showing ".$count." Doners</p></div>";
...
<div class="col-lg-3 col-md-4 col-sm-6 ">
           <div class="mr-1 blood-request-card p-1 mb-3">
             ...
             <a href="blood-request.php?brid=<?php echo $getdata['did']; ?>"> <button class="bg-info p-1 ">See Profile <i class="fas fa-eye"></i> </button></a>
